# 266b3dd3-22b1-4d14-b4a5-19ba4173ff1a implementation handoff

This archive is the source of truth for turning the design into production code. Start from `mhxy-toolbox-prototype.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `mhxy-toolbox-prototype.html`
...
- A single self-contained `mhxy-toolbox-prototype.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `mhxy-toolbox-prototype.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
1. Inspect `mhxy-toolbox-prototype.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
